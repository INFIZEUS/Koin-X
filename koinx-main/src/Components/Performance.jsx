...
function Performance() {
  return (
    <div className=' s:w-full p-2  '>
      ...
      <div className='text-nowrap cursor-pointer' ><span>New Insights</span> </div>    
      ...
      <hr className='font-bold pb-2 '/>
       <div className='bg-white rounded-md p-7 s:w-full lg:full'>
        ...
        <h1 className='text-2xl font-semibold pb-2'>Performance</h1>
    ...
    <div>
        <div className='flex my-auto gap-2 text-xl text-slate-600 font-semibold py-3'>Fundamentals

  ...
  return (
    <div className='w-full mt-4 bg-white'>
      <div className='p-7 rounded-lg'>
          ...
          <CoinCarousel className="mt-4 w-3/12s:full s:overflow-scroll s:overflow-y-hidden flex gap-8 m-4" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none' }} coins={youMayLikeCoins} />
  ...
  return (
    <Slider {...settings}>
      {coins.map((coin, index) => (
        <div key={index}>
          <div className="p-2 m-1 gap-6 border border-slate-200 shadow-lg rounded-xl h-auto">

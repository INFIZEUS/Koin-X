...
function Sentiments() {
  return (
    <div className='s:w-full p-2  max-h-max'>
      ...
      <div className='bg-sky-200 rounded-lg p-4 h-max flex gap-2'><div className='w-48 h-max' ><img className='cover'src={img1}/></div> <div className='flex flex-col pb-2'><div className='font-semibold '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, excepturi?</div><div className='text-slate-600'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officia asperiores necessitatibus delectus ab tempore atque perspiciatis ratione eligendi! Exercitationem qui nesciunt blanditiis consectetur id consequatur perferendis quidem amet debitis.</div></div></div>
